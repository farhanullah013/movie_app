...
import 'package:Movie_App/components/calendar_day.dart';
import 'package:Movie_App/components/cienma_seat.dart';
import 'package:Movie_App/components/show_time.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          ...
          child: const InkWell(child: Text('\$' , style: TextStyle(color: Colors.white ,fontSize: 25.0 , fontWeight:FontWeight.bold))),
        )
                ],
              )
          ],
